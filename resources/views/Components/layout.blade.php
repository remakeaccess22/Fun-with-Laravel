        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/" class="{{ true ? 'rounded-md bg-gray-900' : 'text-gray hover:bg-gray-700 hover:text-white' }} px-3 py-2 text-sm font-medium text-white" aria-current="page">Home</a>
    ...
    <div class="md:hidden" id="mobile-menu">
      ...
      <div class="border-t border-gray-700 pb-3 pt-4">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            <div class="text-base font-medium leading-none text-white">Lary Laracast</div>
